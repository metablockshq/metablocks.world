...
const FloatingBanner = () => (
  <div
    className="fixed w-100 z-1 db bottom-0"
    style={{ left: "50%", transform: "translateX(-50%)" }}
  >
    <div
      className="flex pv2 justify-between items-center br3 mb3 ph3"
      style={{
...
const Heading = ({ title, subTitle, titleClassName = "" }) => (
  <div>
    ...
    {subTitle && (
      <h2 className="f5 f5-m f4-l black-80 normal nt1 lh-copy">{subTitle}</h2>
    )}
  </div>
);
...
const Hero = ({ openSignupDialog }) => (
  <div
    className="pt4 dt w-90 br3 center"
    style={{ backgroundColor: darkGreen, color: offWhite }}
  >
    <div className="dtc v-mid tc">
      <div className="w-90 f5 f4-ns w-80m w-40-l center">
        Meta Blocks is an NFT Evolution Protocol that lets you build up your
        NFTs, buy accessories that you like and trade them on secondary
        marketplaces.
      </div>
      <h1 className="f1 f-subheadline-m f-headline-l nb4 mt3">Unleash NFTs</h1>
      <img
...
const howCols = [
  {
    ...
    description: (
      <>
        <p>
          The base layer defines your characters features like skin color, body
          structure, hair type and basic shoes. Minting also comes with an
          optional pair of clothing.{" "}
          <strong>Base layers are not-scarce hence not valuable</strong>.
        </p>
      </>
    ),
  },
  {
    ...
    description: (
      <p>
        Frequent drops introduce limited edition collectibles. These NFTs
        augment with your base layer to form a hybrid scene. Drops can happen at
        anytime. <strong>Drops can be collected and resold.</strong>
      </p>
    ),
  },
  {
    ...
    description: (
      <p>
        Generate multiple scenes that showcase one or more of your collectibles.
        Everything stays on-chain as a single token.{" "}
        <strong>
          You can also create parallel-universe renders of your collection.{" "}
        </strong>
      </p>
    ),
  },
...
const DataNotRenders = ({ openSignupDialog }) => (
  ...
  >
    <Heading
      title={"Contract stores data not renders"}
      subTitle={
        "When you buy items, the new traits are added to your original NFT. The old NFT is either burnt or held in a contract for later release."
      }
    />
...
const multiverseRenders = [
  { id: 1, title: "Presenting render", imageSrc: characterPresenting },
...
const Multiverse = () => (
  <div className="tc pv4" style={{ backgroundColor: lightGreen }}>
    <Heading
      title="GENFTs help form multiverses"
...
const parallelUniverseCharacters = [
  { id: 1, title: "Human Verse", imageSrc: characterPresenting },
...
const useCases = [
  {
    ...
    body: (
      <p>
        Meta Blocks collectibles can be used to express yourself in your day to
        day communications. This brings <strong>real world utility</strong> to
        your digital assets.
      </p>
    ),
  ...
  },
  {
    ...
    body: (
      <p>
        Auto generate visuals for any text input, like tweets. Visuals can be
        shared on various photo based social networks. The generated visuals are
        a function of your Meta Blocks. This{" "}
        <strong>unlocks a new wave of creative influencers</strong>.
      </p>
    ),
    image: instagramPost,
  },
  {
    ...
    body: (
      <p>
        With advances in text to speech specially with MelGans (et. al. Lyrebird
        AI), vocal footprint can be encoded as a trait and used to generate
        audio content from text. A{" "}
        <strong>user can encode their own voice or buy a unique voice</strong>{" "}
        from the market.
      </p>
    ),
    image: podcast,
  },
  {
    ...
    body: (
      <p>
        Open source 3d meshes and traits info will enable game developers to
        encode NFT traits into game characters. We plan to build an open SDK for
        game studios and{" "}
        <strong>encode this character into Minecraft ourselves</strong>.
      </p>
    ),
    image: minecraft,
  },
...
const UseCase = ({ title, body, image, containerClass, containerStyle }) => (
  <div
    className={`br3 flex flex-column flex-row-ns items-center ph4 pv3 ${containerClass}`}
    style={{ ...containerStyle, ...{ backgroundColor: "rgb(255, 230, 230)" } }}
  >
    <img
      src={image}
      alt={title}
      className="vh-25 vh-25-m vh-50-l mr0 mr4-ns br4 shadow-3"
    />
    <div>
...
const IntroAndDemo = () => (
  <div className="w-90 center flex flex-wrap justify-between">
    <Video
      ytId="wk2levrLxHA"
    ...
    <Video
      ...
      subTitle={
        <>
          ...
          extension. You can check the app in the demo at{" "}
          <a
...
const GiveAway = () => (
  <div
    className="w-90 center lh-copy mt3 br3 pv2 ph4"
  ...
  >
    <div className="flex items-center flex-wrap justify-center">
      ...
      <div className="ml0 ml0-m ml3-l black-80 w-100 w-auto-ns tc tc-m tl-l mt3 mt2-m mt0-l">
        ...
        <p className="mt0 mb3 f6 f5-ns">
          Vote for us on the Solana Igntion Hackathon and get the first mainnet
          drop delivered to your wallet.
        </p>
        <a
          href={gleamLink}

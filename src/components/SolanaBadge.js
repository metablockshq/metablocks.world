...
const MqItem = ({imgSrc, imgAlt, title, href, aBody}) => (
	...
	<img src={imgSrc} alt={imgAlt} className="mr2"
	     style={{height: 24}} />
	<span className="bl b--black-60 ph1 black-80 f5">
	  {title}
	</span>
	{href &&
	 <a href={href} target="_blank" className="blue b ml2 pointer">{aBody}</a>}
      </div>
)

const SolanaBadge = () =>
  (<div className="fixed pa1 bottom-0 w-100"
	style={{

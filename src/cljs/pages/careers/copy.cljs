...
(hx/defnc Copy []
  [:div {:class "w-90  w-50-ns center mt4 black-80 f4 lh-copy"}
   ...
   [:p "We are a group of hackers who started riding the internet wave 10years ago and have built a stable cruise ship now. At our core, we are a consultancy business but we also incubates products (and ideas)."]
   ...
   [:p "Although our clients range from enterprise companies to data-focused startups, the majority of our experience lies in the b2b enterprise space."]
   ...
   [:ul
    ...
    [:li "Informal work environment with a minimal heirarchy."]
